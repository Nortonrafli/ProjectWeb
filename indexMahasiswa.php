    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <ul class="sub">
            <li><a href="indexMahasiswa.php">Data Peminjaman</a></li>
            </ul>
          </li> 
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <br>
              <table cellpadding="0" cellspacing="0" border="2" class="display table table-bordered" id="hidden-table-info">
                ...
                <tr>
                    ...
                    <td>
                    <a href="Update_peminjaman.php"class="btn btn-theme start" >
                    <i class="glyphicon glyphicon-upload"></i>
                    <span>Edit</span>
                    </a>
                   
                  <button type="button" class="btn btn-theme04 delete" href="hapus.php?Kode_Buku=<?php echo $row["Kode_Buku"];?>"onclick="return confirm('Apakah data ini akan dihapus')">
