...
<?php
//untuk memanggil function1 supaya tidak terjadi adanya tabrakan data
      ...
      <section class="wrapper">
        ...
        <div class="row mb">
          ...
          <div class="content-panel">
            <div class="adv-table">
            <a href="Tambah_Mahasiswa.php" class="pull-left btn btn-theme02">+ Tambah Mahasiswa</a>
            <br>
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tr>
                    ...
                    <td><?= $row["Jurusan"]; ?></td>
                    <td>
                    <a class="btn btn-theme start" href="Update_mahasiswa.php?id=<?php echo $row["id"];?>" >
                    <i class="glyphicon glyphicon-upload"></i>
                    <span>Edit</span>
                    </a>
                  
                  <a class="btn btn-theme04 delete" href="HapusMahasiswa.php?id=<?php echo $row["id"];?>"onclick="return confirm ('Apakah data ini akan dihapus')">
